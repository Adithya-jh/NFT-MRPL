...
export default function CreatorCard({
  ...
  return (
    <div
     ...
     bg-white border dark:border-nft-black-3 border-nft-gray-1 rounded-3xl flex flex-col p-4 m-4"
    >
      ...
      <div className="my-2 flex justify-center">
        <div className="relative w-20 h-20 minlg:w-28 minlg:h-28">
          <Image src={CreatorImage} alt="creator" className="rounded-full" />
      ...
      <div className="mt-3 minlg:mt-7 text-center flexCenter flex-col">
        ...
        <div className="mt-1 font-poppins dark:text-white text-nft-black-1 font-semibold text-base">
